...
//     const artist = searchArtistInput.value;
//     const minYear = searchMinYearInput.value;
//     const maxYear = searchMaxYearInput.value;
...
//     const url = `/api/songs/search?${params.toString()}`;
//     console.log("Calling:", url); // good for teaching
